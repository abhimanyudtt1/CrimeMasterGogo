...
class TestLoginToUI_1(unittest.TestCase):
    ...
    def test_testLogin(self):
        testResults.summary("Testing Discount - Discount Level For Discounted Products")
        driver = gogo.appUI.init()
        gogo.appUI.login()
        gogo.appUI.goToInsight('discount_level_for_discounted_products')
        ...
        expected_url = '%s/insights?insight=productDiscountBands&entity=sku&category=1&date=1438560000000,1441584000000&mode=sku' % parser.URL
