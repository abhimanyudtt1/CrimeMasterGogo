...
class TestLoginToUI_1(unittest.TestCase):
    def test_testLogin(self):
        testResults.summary("Testing Discount - Discount Change in Price and Product Count")
        driver = gogo.appUI.init()
        gogo.appUI.login()
        gogo.appUI.goToInsight('discount_change_in_price_and_product_count')
        ...
        expected_url = '%s/insights?insight=productDetail&entity=sku&date=1438560000000,1441584000000&category=1,1414&mode=sku' % parser.URL
