...
class TestLoginToUI_1(unittest.TestCase):
    ...
    def test_testLogin(self):
        testResults.summary("Testing Product assortment - Cumulative Rating")
        driver = gogo.appUI.init()
        gogo.appUI.login()
        gogo.appUI.goToInsight('product_assortment_cumulative_rating')
        ...
        expected_url = '%s/insights?insight=productRatings&entity=sku&date=1438560000000,1441584000000&category=1&mode=sku' % parser.URL
